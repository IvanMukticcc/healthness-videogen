...
def main():
    ...
    # The micronutrient badges. Off unless --micro is given, so every earlier
    # command line still renders exactly the video it used to.
    ...
    for f in range(frames):
        ...
        # Last, and outside the protect pass: the badges are drawn on top of the
