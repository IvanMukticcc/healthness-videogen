...
## Where things live
    ...
    ShortPrompt/
      ...
      MikroVersion/     the food version: bowls, organs, micronutrients
      ExerciseVersion/  this one: lifts, bodies, muscles. This file.
...
Run everything from inside `ExerciseVersion/`. It writes nothing outside itself.
...
ffmpeg -y -i work/<topic>_silent.mp4 -i ASSETS/lift_bed_8s.m4a -i work/<topic>_hits.wav \
