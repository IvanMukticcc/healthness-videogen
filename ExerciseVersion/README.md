# ExerciseVersion — the same clip, about lifting
...
`work/`. `.venv` is a symlink to `../OTHER/.venv`. It reads `../ASSETS/Vitamini`
...
```
./render.sh push work/push_labelled.png \
...
```
./render.sh push work/push_labelled.png 'Chest:p,Triceps:s,Front Delts:s;Lats:p,...'
```
...
| `ASSETS/Muscle/` | 84 badges, 512px, plus `_ball.png`, the blank sphere |
| `ASSETS/lift_bed_8s.m4a` | the bed, synthesised, seamless, −18.4 LUFS |
